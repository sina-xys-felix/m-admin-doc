<template><div><h1 id="mform" tabindex="-1"><a class="header-anchor" href="#mform"><span>MForm</span></a></h1>
<p>MForm 是基于<a href="https://arco.design/vue/docs/start" target="_blank" rel="noopener noreferrer">arco-design-vue</a>的form二次封装的 Form 组件，
支持所有原生参数、事件、插槽，同时增强了部分功能。</p>
<div style="height: 1px; background: linear-gradient(to right, transparent, #42b983, transparent); margin: 2em 0;"></div>
<p><strong>使用示例</strong></p>
<p>由于篇幅问题，具体使用场景请查看<a href="https://github.com/sina-xys-felix/M-Admin/blob/main/src/views/form/config/index.vue" target="_blank" rel="noopener noreferrer">github</a>。</p>
<p><strong>MFormProps</strong></p>
...
<p><strong>MFormItemProps</strong></p>
<table  style="width:100%;margin-bottom:40px">
        <thead>
            <tr>
                <th>Property</th>
