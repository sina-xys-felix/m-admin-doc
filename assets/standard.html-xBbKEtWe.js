import{_ as n,c as a,a as e,o as l}from"./app-DOEjJb59.js";const i={};function p(c,s){return l(),a("div",null,s[0]||(s[0]=[e(`<h1 id="项目代码规范" tabindex="-1"><a class="header-anchor" href="#项目代码规范"><span>项目代码规范</span></a></h1><h4 id="全局组件-命名规范" tabindex="-1"><a class="header-anchor" href="#全局组件-命名规范"><span>全局组件--命名规范</span></a></h4><p>组件命名：<strong>单文件组件的文件名以m开头，并以横线连接 (kebab-case)</strong></p><p>可参考 Vue2 官网-风格指南: https://v2.cn.vuejs.org/v2/style-guide/</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">m-table</span>
